...
class WorldControllerIT {
    ...
    void worldEndpointReturnsCurrentTickAndGrid() throws Exception {
        MockHttpSession session = registerAndLogin(mockMvc, objectMapper, "sulu", "sulu@enterprise.example", "warp-factor-nine");
    ...
    void worldShipsReturnsEveryUsersShip() throws Exception {
        ...
        registerAndLogin(mockMvc, objectMapper, "kirk", "kirk@enterprise.example", "to-boldly-go1");
        MockHttpSession spock = registerAndLogin(mockMvc, objectMapper, "spock", "spock@enterprise.example", "live-long-prosper");
