...
public class ShipOrderService {
     ...
     *
     * <p>EXTRACT and SELL queued from a non-ORBITING position are NOT
     * auto-prefixed with a MOVE — they cancel at tick time with a clear
     * reason. The player is expected to MOVE adjacent to the body first.
     */
    @Transactional
